...
对流耦合赤道波动控制了热带一部分的降水变率，其水平结构和频散特征来自于Matsuno's(1966)在赤道$\beta$
平面上的浅水方程的解，包括：
...
由于存在湿过程的影响，他们的倾斜垂向结构是复杂的，而且他们的尺度与理论干波的期望结构不一致。

 

CCEWs的动力结构和云形态在一个令人惊讶的大尺度范围内显示出很大程度的自相似性，其**前缘为浅对流，其次是深对流，然后是层云降水**，反映了单个中尺度对流复合体的特征。
...
![Fig1.png](https://s2.loli.net/2024/03/25/TM6HFNvEte9sCI1.png)
 
 

值得注意的是，这些CCEW的频散特性和结构与线性理论预测的频散特性和结构大体一致，即使不考虑基本流的潜在影响，也不考虑与对流耦合产生的非线性效应。
...
![Fig2.png](https://s2.loli.net/2024/03/25/V7Xxcte1HuDhGKQ.png)
...
![Fig3.png](https://s2.loli.net/2024/03/25/cNGWaxhsZkjnR4p.png)
...
![table1.png](https://s2.loli.net/2024/03/25/tZiUlgNmev6QrRK.png)
 
...
$$
\frac{\partial u}{\partial t}-f\nu+\frac{\partial\phi}{\partial x}=0,\quad\quad\quad\quad\quad(7)
$$

$$
\frac{\partial v}{\partial t}+fu+\frac{\partial\phi}{\partial y}=0,\quad\quad\quad\quad\quad(8)
$$

$$
\frac{\partial u}{\partial x}+\frac{\partial\nu}{\partial y}+\rho_0^{-1}\frac{\partial(\rho_0w)}{\partial z}=0,\quad\quad\quad\quad(9)
$$
...
$$\exp(z/2H)\sin(mz+b)\quad\quad\quad\quad(15\text{b})$$
...
$$\exp(z/2H)\cos(\textit{т}z+kx),\quad\quad\quad\quad\quad(16\text{a})$$

 

$$\exp(z/2H)\sin(mz+b)\cos(kx).\quad\quad\quad\quad(16\text{b})$$
...
![Fig4.png](https://s2.loli.net/2024/03/25/QvL4r8dY67hSmfU.png)
...
##  Miexed ROSSBY-GRAVITY WAVES 混合罗斯贝重力波 
 
...
![Fig12-MRG.png](https://s2.loli.net/2024/03/25/Ln4XT9rQpKmVGft.png)
...
下图展示了850hpa环流pattern与理论结构十分吻合，涡旋以赤道为中心且关于赤道对称，$T_b$信号反对称,波长大约9000km

 

![Fig13.png](https://s2.loli.net/2024/03/25/lD6dXhOs1GbTCio.png)
...
 
![Fig14.png](https://s2.loli.net/2024/03/25/ZPSX8zkvfdV3u27.png)
 
...
> Kiladis, G. N., M. C. Wheeler, P. T. Haertel, K. H. Straub, and
